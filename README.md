...
|---|---|
| [`ARCHITECTURE.md`](./ARCHITECTURE.md) | The single-file structure: data (nodes/edges/upgrades), state, render loop, and the roadmap fork (Globe.gl 3D map vs. a full engine rewrite) — neither started. |
