...
1. Navigate to [Report a Vulnerability](https://github.com/metadatastician/688-attack-hub/security/advisories/new)
...
- This repository (`metadatastician/688-attack-hub`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/metadatastician/688-attack-hub/security/advisories)
...
When using 688 Attack Hub, we recommend:
...
- [Security Advisories](https://github.com/metadatastician/688-attack-hub/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/metadatastician/688-attack-hub/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/metadatastician/688-attack-hub/discussions) |
...
*Thank you for helping keep 688 Attack Hub and its users safe.* 🛡️
