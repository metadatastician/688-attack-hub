...
# @a2ml-metadata begin
# (
#   id                   = "688-attack-hub-launcher"
#   type                 = "launcher"
#   version              = "0.1.0"
#   app-name             = "688-attack-hub"
#   app-display          = "688 Attack Hub"
...
#
# ============================================================================
# 688-attack-hub-launcher.sh — 688 Attack Hub
# ============================================================================
# GENERATED by launch-scaffolder from 688-attack-hub.launcher.a2ml.
...
APP_NAME="688-attack-hub"
APP_DISPLAY="688 Attack Hub"
APP_DESC="Game"
APP_CATEGORIES="Game;"
APP_GENERIC_NAME="688 Attack Hub"
...
CONFIG_FILE="/home/hyperpolymath/developer/meta-repos/688-attack-hub/688-attack-hub.launcher.a2ml"

URL="http://localhost:3000"
APP_PORT="3000"
WAIT_SECONDS="15"

PID_FILE="${XDG_RUNTIME_DIR:-${TMPDIR:-/tmp}}/688-attack-hub.pid"
LOG_FILE="${XDG_STATE_HOME:-$HOME/.local/state}/688-attack-hub/game.log"
...
[runtime].startup-command-search or [runtime].command in 688-attack-hub.launcher.a2ml."
            return 1
        fi
    fi
