...
* **License**: AGPL-3.0-or-later for code and prose — this repo sits in the
  `metadatastician` org convention for co-developed work (per
  standards/LICENCE-POLICY.adoc Rule 3), not the general MPL-2.0/CC-BY-SA-4.0
  fallback
* **Code of Conduct**: Follows hyperpolymath CODE_OF_CONDUCT.md
* **Security**: Follows hyperpolymath SECURITY.md
* **Contributing**: Follows hyperpolymath CONTRIBUTING.md conventions
...
| **Contractiles** | Must/Trust/Bust/Intend/Adjust/Dust files under `.machine_readable/contractiles/`

| **Machine Readable** | META.a2ml and siblings in `.machine_readable/descriptiles/`

| **No formal verification claims** | Unlike this org's `f19-stealth-glider`, this repo makes no provable design claims — see `AUDIT.adoc`
...
* link:AUDIT.adoc[Audit — what is and isn't verified about this repo]
...
| 2026-07-21 | Initial governance model established | @hyperpolymath
|===
